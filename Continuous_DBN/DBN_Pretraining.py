...
def test_DBNPretraining(pretraining_epochs=100,
    ...
    Pretraing_params = copy.deepcopy(dbn.params)

    params = '/home/wangyang/DeepLearningTutorials/data/DBNPretraining_Params'
    save_file = open(params, 'wb')
    W1 = Pretraing_params[0]
    b1 = Pretraing_params[1]
    W2 = Pretraing_params[2]
    b2 = Pretraing_params[3]
    W3 = Pretraing_params[4]
    b3 = Pretraing_params[5]
    W4 = Pretraing_params[6]
    b4 = Pretraing_params[7]
