...
class GRBM(object):
    ...
    def get_cost_updates(self, lr=0.1, persistent=None, k=1):
        ...
        #Set smaller learning rate for GB-RBM
        lr = 0.1 * lr
...
def test_grbm(learning_rate=0.001, training_epochs=100,
             dataset='/home/wangyang/DeepLearningTutorials/data/mnist.pkl.gz', batch_size=20,
